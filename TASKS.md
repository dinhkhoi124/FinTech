...
| W3-003-EV2-R1-PUB1 | 3 | P0 | Freeze and publish Senior-accepted valid-fail R1 evidence | Publish only exact frozen R1 score, summary, executed notebook, notebook receipt, report, and R1 lifecycle evidence; no recomputation or remediation | IN PROGRESS / P0_RELEASE_CLOSURE_MODE |
