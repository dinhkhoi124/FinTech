...
| W3-003 | 3 | P0 | Grounded RAG Behavior Remediation | EV1 executed, frozen, remotely verified, and consumed; product gate failed and remediation must use non-locked development evidence before any new independent gate | IN_PROGRESS / REMEDIATION REQUIRED |
...
| W3-003-EV2-E1-PUB1 | 3 | P0 | Publish canonical Class-A E1 raw artifact set | Commit only authorized AUTH1/E1/Class-A evidence and lifecycle corrections; exclude JIT/helpers and unrelated dirty work; remote bytes must remain exact | IN PROGRESS / APPROVED TO COMMIT AND PUSH |
...
| W3-003-EV3 | 3 | P0 | Independent one-shot post-RM3 evaluation | Candidate publication requires Senior fresh-remote verification before separate explicit authorization | BLOCKED / NOT EXECUTED / NOT YET AUTHORIZED |
